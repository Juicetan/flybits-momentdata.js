...
var codePaths = [paths.startCode, paths.main, paths.utilities, paths.interfaces, paths.models, paths.controllers, paths.store, paths.context, paths.apiWrappers, paths.exportCode, paths.endCode];

var pluginName = "flybits-momentdata.js";
var pluginMinifiedName = "flybits-momentdata.min.js";
...
gulp.task('watchChanges',function(){
  ...
  var paths = codePaths.slice(0,codePaths.length);
